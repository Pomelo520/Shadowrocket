  ...
  const initEvents = () => {
    ...
    $("#confirmOk").onclick = () => {
      if (state.pendingInstall) {
        ...
        const url = `https://pomelo520.github.io/Shadowrocket/Static/Redirect.html?url=shadowrocket://install?module=https://pomelo520.github.io/Shadowrocket/Release/Modules/${f}`;
